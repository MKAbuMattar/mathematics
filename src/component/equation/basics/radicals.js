...
function radicals() {
  const equation_1 = '\\sqrt[n]{a}=a^{\\frac{1}{n}}',
    equation_2 = '\\sqrt[n]{a\\times b}=\\sqrt[n]{a}\\times\\sqrt[n]{b}',
    equation_3 = '\\sqrt[n]{\\frac{a}{b}}=\\frac{\\sqrt[n]{a}}{\\sqrt[n]{b}}',
    equation_4 = '\\sqrt[m]{\\sqrt[n]{a}}=\\sqrt[m\\times n]{a}',
    ...
    <div>
      <Container fluid="md">
        ...
        <Row>
          ...
          <Col sm={9}>
            <div>
              <p className="display-3" style={{ marginTop: "-22px" }}>Radicals</p>
