...
function header() {
    return (
        <div>
            <header>
                <div className="introduction noselect">
                    <svg viewBox="0 0 300 300" width="110" className="d-inline-block align-top" fill="#d52128">
                    ...
                    Mathematics
                    <Link class="link mouse_scroll" to="topmain">
                        <div>
